    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-indigo-900 p-8 rounded-[32px] text-white shadow-xl flex items-center justify-between">
          <div>
            <p className="text-[10px] font-black text-indigo-300 uppercase tracking-widest mb-2 flex items-center gap-2"><ShieldCheck size={14} /> Custos de Segurança</p>
        ...
        <div className="bg-white p-8 rounded-[32px] border border-slate-100 flex flex-col justify-center">
          ...
          <div className="flex items-end gap-4">
            <span className="text-3xl font-black text-slate-900">R$ {annualTotal.toLocaleString('pt-BR')}</span>
        ...
        {fixedTs.length === 0 ? (
          ...
          fixedTs.map(t => (
            <div key={t.id} className="bg-white p-5 rounded-2xl border border-slate-100 flex items-center justify-between hover:border-indigo-200 transition-all group">
               ...
               <div className="flex items-center gap-4">
                 <span className="font-black text-slate-800">R$ {t.amount.toLocaleString('pt-BR')}</span>
