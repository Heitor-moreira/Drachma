...
interface Props { date: string; transactions: Transaction[]; cards?: CreditCard[]; currencySymbol: string; liteMode?: boolean; onBack: () => void; onAdd: (date: string) => void; }
...
const DayTransactionsView: React.FC<Props> = ({ date, transactions, cards = [], currencySymbol, liteMode = false, onBack, onAdd }) => {
